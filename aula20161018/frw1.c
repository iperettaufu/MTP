...
void receberDados() {
    FILE * arquivo; char nome[NCHAR]; int idade; float altura_m;
    printf("Entre com seu nome: "); fgets(nome, NCHAR, stdin);
    printf("Entre com sua idade: "); fscanf(stdin, "%d", &idade);
    printf("Entre com sua altura: "); fscanf(stdin, "%f", &altura_m);
